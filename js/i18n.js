...
export const DICTIONARY = {
    "pt-BR" : {
        ...
        grade_scale: {
            ...
            "3": "Levemente negativo. Impacto desfavorável, porém, limitado ou pontual.",
            "4": "Neutro ou irrelevante. Nenhum impacto sobre a imagem.",
            "5": "Levemente positivo. Impacto favorável, porém, limitado ou pontual.",
        ...
        chart_histogram_help: "Frequência de notas atribuídas às notícias no período selecionado",

        // Volume chart
        chart_volume_title: "Quantidade de notícias",
        chart_volume_help: "Volume total de notícias analisadas ao longo do tempo",
        ...
        btn_add_layer: "Comparar",
        scope_global: "",
        scope_layer: "",
        chips_caption: "Comparações",
        hand_hint: "Mesa vazia — ajuste os seletores e clique Comparar",
        hand_dup_hint: "Combinação já está na mesa — altere um seletor",
        chip_pin_tip: "Fixar o destaque desta linha",
        newsstand_empty_pos: "Nenhuma notícia positiva neste ponto",
        newsstand_empty_neu: "Nenhuma notícia neutra neste ponto",
        newsstand_empty_neg: "Nenhuma notícia negativa neste ponto",
        layer_no_data: "sem avaliações no período",
        layer_principal_tip: "Camada principal: alimenta os gráficos de apoio: distribuição de notas, quantidade de notícias e indicador atual",
        layer_make_principal_tip: "Tornar principal: a camada principal alimenta os gráficos de apoio (distribuição de notas, quantidade de notícias e indicador atual)",
        chip_drag_tip: "Arraste sobre outra ficha para mesclar as linhas em uma só",
        merge_hint: "Dica: arraste uma ficha sobre outra para mesclar as linhas em uma só",
        hint_dismiss: "Dispensar dica",
        layer_remove: "Remover comparação",
        layer_edit_tip: "Editar esta linha nos seletores",
        layer_group_tip: "Série mesclada: união das notícias das combinações (sem dupla contagem)",
        layer_split: "separar",
        layer_split_tip: "Desfazer a mescla",
    ...
    "en-US": {
        ...
        newsstand_desc: "News published between {start} and {end}, evaluated by {evaluator} about {evaluated}",
        nav_filters: "Filters",
        nav_metrics: "Main metrics",
        nav_evolution: "Evolution over time",
        nav_newsstand: "News at this point",
        bucket_neg: "Negative",
        bucket_neu: "Neutral",
        bucket_pos: "Positive",
        ...
        scope_global: "Global",
        scope_layer: "Layer",
        chips_caption: "Active layers",
        hand_hint: "Empty table — adjust the selectors and click + Layer",
        hand_dup_hint: "This combination is already on the table — change a selector",
        chip_pin_tip: "Pin this line\u2019s highlight",
        newsstand_empty_pos: "No positive news at this point",
        newsstand_empty_neu: "No neutral news at this point",
        newsstand_empty_neg: "No negative news at this point",
        layer_no_data: "no evaluations in this period",
        layer_principal_tip: "Principal layer — feeds the support charts: grade frequency, news quantity and current indicator",
        layer_make_principal_tip: "Make principal — the principal layer feeds the support charts (grade frequency, news quantity and current indicator)",
        chip_drag_tip: "Drag onto another chip to merge the layers into a single line",
        merge_hint: "Tip: drag one chip onto another to merge their lines into one · the ★ picks the layer for the support charts (grades, news and current indicator)",
        hint_dismiss: "Dismiss tip",
        layer_remove: "Remove layer",
        layer_edit_tip: "Edit this layer in the selectors",
        layer_group_tip: "Merged series: union of the combinations\u2019 news (no double counting)",
        layer_split: "split",
        layer_split_tip: "Undo the merge",
    ...
    "es-ES": {
        ...
        newsstand_desc: "Noticias publicadas entre {start} y {end}, evaluadas por {evaluator} sobre {evaluated}",
        nav_filters: "Filtros",
        nav_metrics: "Métricas principales",
        nav_evolution: "Evolución temporal",
        nav_newsstand: "Noticias del punto",
        bucket_neg: "Negativas",
        bucket_neu: "Neutras",
        bucket_pos: "Positivas",
        ...
        grade_scale: {
            ...
            "3": "Levemente negativo. Impacto desfavorable, pero limitado o puntual.",
            "4": "Neutro o irrelevante. Ningún impacto sobre la imagen.",
            "5": "Levemente positivo. Impacto favorable, pero limitado o puntual.",
        ...
        scope_global: "Global",
        scope_layer: "Capa",
        chips_caption: "Capas activas",
        hand_hint: "Mesa vacía — ajuste los selectores y pulse + Capa",
        hand_dup_hint: "La combinación ya está en la mesa — cambie un selector",
        chip_pin_tip: "Fijar el resaltado de esta línea",
        newsstand_empty_pos: "Ninguna noticia positiva en este punto",
        newsstand_empty_neu: "Ninguna noticia neutra en este punto",
        newsstand_empty_neg: "Ninguna noticia negativa en este punto",
        layer_no_data: "sin evaluaciones en el período",
        layer_principal_tip: "Capa principal — alimenta los gráficos de apoyo: frecuencia de calificaciones, cantidad de noticias e indicador actual",
        layer_make_principal_tip: "Hacer principal — la capa principal alimenta los gráficos de apoyo (frecuencia de calificaciones, cantidad de noticias e indicador actual)",
        chip_drag_tip: "Arrastre sobre otra ficha para fusionar las capas en una sola línea",
        merge_hint: "Consejo: arrastre una ficha sobre otra para fusionar sus líneas en una sola · la ★ elige la capa de los gráficos de apoyo (calificaciones, noticias e indicador actual)",
        hint_dismiss: "Descartar consejo",
        layer_remove: "Quitar capa",
        layer_edit_tip: "Editar esta capa en los selectores",
        layer_group_tip: "Serie fusionada: unión de las noticias de las combinaciones (sin doble conteo)",
        layer_split: "separar",
        layer_split_tip: "Deshacer la fusión",
